...
def InsertStudentsAttendance(class_id, date, studentsInfo, option="None"):
    try:
        ...
        for i in range(len(studentsInfo)):
            ...
            cur.execute(sql2, (studentInfo["id"], studentInfo["attendId"], date, class_id, studentInfo["courseId"],))
        conn.commit()
...
if __name__ == "__main__":
    print(InsertStudentsAttendance("1","2023-09-14",[{"id":"1", "attendId":"1", "courseId":"1"},]))
